...
<body class="p-0 margin-0 bg-gray-100 min-h-screen">
    ...
    <!-- Clima -->
    <div id="weatherGlass" class="flex w-52 h-16 items-center justify-center bg-resene rounded-md p-2 backdrop-blur-md shadow-lg ml-4"
    ...
    <!-- Horário -->
    <div id="clockGlass" class="flex w-48 h-16 items-center justify-center bg-resene rounded-md p-2 backdrop-blur-md shadow-lg mr-4"
        style="box-shadow: 0 4px 32px 0 rgba(31, 38, 135, 0.15);">
